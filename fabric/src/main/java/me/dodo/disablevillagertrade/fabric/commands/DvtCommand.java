package me.dodo.disablevillagertrade.fabric.commands;
...
/**
 * Registers the {@code /dvt} command for the Fabric platform.
 *
 * <p>Subcommands:
 * <ul>
        ...
        dispatcher.register(
            Commands.literal("dvt")
                ...
                .then(Commands.literal("reload")
                    .executes(ctx -> {
                        DisableVillagerTradeFabric.getConfig().reload();
                ...
                .then(Commands.literal("status")
                    .executes(ctx -> {
                        sendLines(ctx.getSource(),
                            CommandHandler.buildStatusLines(DisableVillagerTradeFabric.getConfig(), "Fabric"));
                        return 1;
                    }))
